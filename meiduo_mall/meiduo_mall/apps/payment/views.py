...
class PaymentView(APIView):
    ...
    def get(self, request, order_id):
        ...
        alipay = AliPay(
            ...
            sign_type="RSA2",  # 加密算法 RSA 或者 RSA2
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            subject='美多商城%s' % order_id,  # 注意：如果变量是字符串类型必须用%s占位,如果变量是int类型可以用%d也可以用%s占位
