...
from .serializers import CartSerializer, CartDeleteSerializer, CartSKUSerializer,CartSelectedSerializer
...
class CartView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            if selected:  # 判断当前商品是否勾选，吧勾选的商品sku_id添加到set集合中
            ...
            response.set_cookie('carts',cart_str,1000)
    ...
    def put(self,request):
        ...
        try:
            ...
            redis_conn = get_redis_connection('cart')
            pl = redis_conn.pipeline()
            #  创建redis连接对象hash 字典：{sku_id_16:2, sku_id_2:1}
            #  勾选状态set集合中{sku_id_16, sku_id_2}
